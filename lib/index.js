...
var _visNetwork = _require("vis-network");
...
var Graph = function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function componentDidMount() {
      this.edges = new _visData.default.DataSet();
      this.edges.add(this.props.graph.edges);
      this.nodes = new _visData.default.DataSet();
    ...
    value: function updateGraph() {
      ...
      this.Network = new _visNetwork.default.Network(this.container.current, Object.assign({}, this.props.graph, {
        edges: this.edges,
        nodes: this.nodes
      }), options);
